...
class DashboardCommand(sublime_plugin.TextCommand):
	def run(self, edit):
		try:
			...
			process = subprocess.Popen("/Users/prithvirajchaudhuri/Desktop/CSC510/Project/venv/bin/python3 '" + dir_path + "/output.py'", shell=True, stdout=subprocess.PIPE)  # noqa: E501, F841
